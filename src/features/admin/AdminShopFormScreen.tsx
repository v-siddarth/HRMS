  ...
  return (
    <Screen>
      <KeyboardAvoidingView
        ...
        <ScrollView
          contentContainerStyle={[styles.content, { paddingBottom: Math.max(insets.bottom + hp(28), hp(36)) }]}
          ...
          <Card>
            ...
            <Field label="Contact Number" keyboardType="phone-pad" value={form.contactNumber} onChangeText={v => setForm(prev => ({ ...prev, contactNumber: v }))} />
            <Field label="Email" keyboardType="email-address" value={form.email} onChangeText={v => setForm(prev => ({ ...prev, email: v }))} />
...
const styles = StyleSheet.create({
  flex: { flex: 1 },
  content: { gap: hp(12) },
  title: { fontSize: sp(21), fontWeight: '800', color: colors.textPrimary },
  subtitle: { color: colors.textSecondary, lineHeight: sp(20), fontWeight: '600', marginBottom: hp(2), fontSize: sp(14) },
  statusWrap: { gap: hp(8) },
  statusLabel: { color: colors.textPrimary, fontWeight: '700', fontSize: sp(14) },
  statusRow: { flexDirection: 'row', gap: wp(8) },
  statusBtn: {
    flex: 1, minHeight: hp(44), borderRadius: wp(10), borderWidth: 1,
    borderColor: colors.border, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center',
  },
  statusBtnPressed: { backgroundColor: colors.surfaceMuted },
  statusBtnActive: { borderColor: '#9ad9c5', backgroundColor: colors.successSoft },
  statusBtnInactive: { borderColor: '#f0bdbd', backgroundColor: colors.dangerSoft },
  statusBtnText: { color: colors.textSecondary, fontWeight: '800', fontSize: sp(14) },
  statusBtnTextActive: { color: colors.success },
  statusBtnTextInactive: { color: colors.danger },
  cancelBtn: {
    minHeight: hp(46), borderRadius: wp(12), borderWidth: 1,
    borderColor: colors.border, alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff',
  },
  cancelBtnPressed: { backgroundColor: colors.surfaceMuted },
  cancelBtnText: { color: colors.textSecondary, fontWeight: '700', fontSize: sp(14) },
  missingWrap: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: hp(10) },
  missingTitle: { color: colors.textPrimary, fontSize: sp(20), fontWeight: '800' },
  missingSub: { color: colors.textSecondary, textAlign: 'center', lineHeight: sp(20), maxWidth: wp(320), fontSize: sp(14) },
  backBtn: {
    minHeight: hp(42), borderRadius: wp(10), backgroundColor: colors.primary,
    paddingHorizontal: wp(16), alignItems: 'center', justifyContent: 'center',
  },
  backBtnPressed: { backgroundColor: colors.primaryPressed },
  backBtnText: { color: '#fff', fontWeight: '800', fontSize: sp(14) },
});
